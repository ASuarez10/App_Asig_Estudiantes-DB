...
SELECT * FROM SELECTION_PROCESSES sp ORDER BY sp.ID_PROCESS DESC;
...
SELECT * FROM CRITERIA_CONFIGURATION cc WHERE cc.AUTOMATIZED = 0;

SELECT * FROM SELECTIONS s WHERE s.ID_SELECTION_PROCESS = 23 AND ID_CANDIDATE = '10000000000';

SELECT * FROM SELECTIONS s WHERE s.ID_SELECTION_PROCESS = 23 ORDER BY s.PERCENTAGE DESC, s.PRIORITY ASC;
